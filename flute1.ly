 ...
 \paper { % for book
  ...
  \bookpart {
    ...
    \score { % Prélude
      ...
      }{\globalPrelude \new Voice <<\dessusPrelude \fluteOnePrelude >>}
    } % end score Prélude
   ...
   \pageBreak   
    \score {
      ...
      \new Staff \with {
        ...
        midiInstrument = "flute"
      }{\globalGavotte \new Voice <<\dessusGavotte \fluteOneGavotte \dessousGavotte >>}
    }% end score Gavotte
    ...
    \score {
      ...
      \new Staff \with {
        instrumentName = "Flûte 1"
        midiInstrument = "flute"
      }{\globalMusette \new Voice <<\dessusMusette \fluteOneMusette \dessousMusette>>}
    } % end score Musette
    \pageBreak
    \score {
      \header {
    ...
    \score {
      ...
      \new Staff \with {
        ...
        midiInstrument = "flute"
      }{\globalRigaudon \new Voice <<\dessusRigaudon \fluteOneRigaudon \dessousRigaudon>>}
