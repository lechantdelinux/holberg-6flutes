 ...
 \paper { % for book
  ...
  \bookpart {
    ...
    \score { % Prélude
      ...
      }{\globalPrelude \new Voice <<\dessusPrelude \fluteThreePrelude >>}
    } % end score Prélude
    ...
    \score {
      ...
      \new Staff \with {
        instrumentName = "Flûte 3"
        midiInstrument = "flute"
      }{\globalSarabande \new Voice <<\dessusSarabande \fluteThreeSarabande>>}
    } % end score Sarabande
   ...
   \pageBreak   
    \score {
      ...
      \new Staff \with {
        instrumentName = "Flûte 3"
        midiInstrument = "flute"
      }{\globalGavotte \new Voice <<\dessusGavotte \fluteThreeGavotte \dessousGavotte >>}
    }% end score Gavotte
    ...
    \score {
      ...
      \new Staff \with {
        instrumentName = "Flûte 3"
        midiInstrument = "flute"
      }{\globalMusette \new Voice <<\dessusMusette \fluteThreeMusette \dessousMusette>>}
    } % end score Musette
    \pageBreak
    \score {
      \header {
      ...
      \new Staff \with {
        instrumentName = "Flûte 3"
        midiInstrument = "flute"
      }{\globalAir \new Voice <<\dessusAir \fluteThreeAir>>}
    } % end score Air
    ...
    \score {
      ...
      \new Staff \with {
        instrumentName = "Flûte 3"
        midiInstrument = "flute"
      }{\globalRigaudon \new Voice <<\dessusRigaudon \fluteThreeRigaudon \dessousRigaudon>>}
